...
test_name="pixi_pythia8_summary"
...
pixi run python macro/validate_simulation_output.py \
  -f "$output_dir/sim_pythia8_summary.root" \
  -o "$output_dir/sim_pythia8_summary.validation.json" \
  | tee "$output_dir/sim_pythia8_summary.validation.stdout" "$output_dir/sim_pythia8_summary.validation.log"
